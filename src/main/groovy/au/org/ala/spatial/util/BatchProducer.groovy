...
class BatchProducer {
    ...
    static String produceBatch(String batchPath, String requestInfo, String fids, String points, String gridcache) {
    ...
    static void addInfoToMap(String batchPath, String batchId, Map map) throws IOException {
    ...
    static void logUpdateEntry(String batchId, String newStatus, String infoKey, String infoValue, Integer newProgress) {
    ...
    private static int getFieldCount(String batchPath, String batchId) throws IOException {
        ...
        if (new File(dir).exists()) {
            ...
            if (f.exists() && f.length() > 0) {
                count = new File(dir + "fids.txt").text.split(",").length
            }
        }
        return count
    }
