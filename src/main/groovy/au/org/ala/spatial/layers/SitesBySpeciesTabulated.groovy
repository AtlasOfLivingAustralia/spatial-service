...
class SitesBySpeciesTabulated {
     ...
     */
    SitesBySpeciesTabulated(double resolution, double[] bbox) {
     ...
     * @throws IOException
     */
    void write(Records records, String outputDirectory, SimpleRegion region, Grid envelopeGrid, String bioregionName, SimpleShapeFile ssf, Grid grid, String[] gridColumns, boolean decade) throws IOException {
        String[] columns = null
    ...
    private Map writeDecades(String outputDirectory, short[] decadeIdx, HashMap<Integer, Integer>[] decMap) {
        ...
        try {
            ...
            fw.write((map as JSON) as String)
            fw.close()
