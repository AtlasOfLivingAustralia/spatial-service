 ...
 */
//@CompileStatic
class LegendObject implements Serializable {
    ...
    LegendObject(Legend numericLegend, QueryField.FieldType fieldType) {
        this.numericLegend = numericLegend
        this.fieldType = fieldType
    }

    LegendObject(String[] categories, int[] counts) {
        ...
        Arrays.sort(objects, new Comparator<Object>() {
            ...
            int compare(Object o1, Object o2) {
                return ((Integer) ((Object[]) o2)[1]) - ((Integer) ((Object[]) o1)[1])
            }
        })
    ...
    static String getRGB(int colour) {
     ...
     * <p/>
     * "string" is the import groovy.transform.CompileStatic
//@CompileStatic
class name, or in the case of
    ...
    void setMinMax(float[] minmax) {

    }

    String[] getCategoryNameOrder() {
        return categoryNameOrder
    }

    void setCategoryNameOrder(String[] cno) {
    ...
    QueryField.FieldType getFieldType() {
        return fieldType
    }

    void setFieldType(QueryField.FieldType ft) {
        this.fieldType = ft
    }
    ...
    void setCategories(HashMap<String, int[]> categories) {
