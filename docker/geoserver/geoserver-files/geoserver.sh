...
#curl -v -u admin:geoserver -XPOST -H "Content-type: application/xml" -d "<user><userName>$USERNAME</userName><password>$PASS</password><enabled>true</enabled></user>>" $GEOSERVER_URL/rest/security/usergroup/users
#fi
