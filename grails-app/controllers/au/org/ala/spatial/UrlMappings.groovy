...
class UrlMappings {
    ...
    static mappings = {
        ...
        "/distribution/map/png/$imageId(.$format)?"(controller: "distribution", action: "overviewMapPng")
        ...
        "/track/map/png/$imageId(.$format)?"(controller: "track", action: "overviewMapPng")
        ...
        "/objects/$fid(.$format)?"(controller: "object", action: "fieldObjects")
//        "/objects/csv/$id(.$format)?"(controller: "object", action: "fieldObjectsCsv")
        "/objects/$fid/$lat/$lng"(controller: "object", action: "listByLocation")
        "/objects/inarea/$fid(.$format)?"(controller: "object", action: "objectsInArea")
        "/object/intersect/$pid/$lat/$lng"(controller: "object", action: "intersectObject")

        "/search(.$format)?"(controller: "search", action: "search")

        "/shape/wkt/$pid(.$format)?"(controller: "shapes", action: "wkt")
        "/shape/geojson/$pid(.$format)?"(controller: "shapes", action: "geojson")
        "/shape/shp/$pid(.$format)?"(controller: "shapes", action: "shp")
        "/shape/shapefile/$pid(.$format)?"(controller: "shapes", action: "shp")
        "/shape/kml/$pid(.$format)?"(controller: "shapes", action: "kml")
