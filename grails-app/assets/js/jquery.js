...
( (e, t) => {
                ...
                if (i = a[1]) {
                    if (9 === f) {
                        ...
                        if (l.id === i)
                            return j.call(n, l),
                                n
                    } else if (c && (l = c.getElementById(i)) && N.contains(e, l) && l.id === i)
                        return j.call(n, l),
                            n
                } else {
                    if (a[2])
    ...
    function De() {
        var n = [];
        function r(e, t) {
            return n.push(e + " ") > S.cacheLength && delete r[n.shift()],
                r[e + " "] = t
        }
        return r
    }
        ...
        return e != E && 9 === e.nodeType && e.documentElement && (r = (E = e).documentElement,
            ...
            r.msMatchesSelector && i != E && (e = E.defaultView) && e.top !== e && e.addEventListener("unload", je),
                g.getById = Ne(function(e) {
                    return r.appendChild(e).id = C.expando,
            ...
            g.cssHas || p.push(":has"),
                ...
                he = function(e, t) {
                    var n;
                    return e === t ? (se = !0,
                        0) : (n = !e.compareDocumentPosition - !t.compareDocumentPosition) || (1 & (n = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !g.sortDetached && t.compareDocumentPosition(e) === n ? e === E || e.ownerDocument == i && N.contains(i, e) ? -1 : t === E || t.ownerDocument == i && N.contains(i, t) ? 1 : oe ? x.call(oe, e) - x.call(oe, t) : 0 : 4 & n ? -1 : 1)
                }
        ),
            E
    }
            ...
            filter: {
                ...
                PSEUDO: function(e, o) {
                    ...
                    return s[A] ? s(o) : 1 < s.length ? (t = [e, e, "", o],
                            S.setFilters.hasOwnProperty(e.toLowerCase()) ? u(function(e, t) {
    ...
    var Qe, Je = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, Ke = ((C.fn.init = function(e, t, n) {
            if (e) {
                ...
                if (!(r = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : Je.exec(e)) || !r[1] && t)
    ...
    C.fn.extend({
        ...
        C.each({
            ...
            C.fn[r] = function(e, t) {
                ...
                1 < this.length && (Ze[r] || C.uniqueSort(n),
                    Ke.test(r)) && n.reverse(),
                    this.pushStack(n)
            }
        });
        ...
        C.extend({
            ...
            when: function(e) {
                ...
                var n = arguments.length
                    ...
                    , o = a.call(arguments)
                    , s = C.Deferred();
                if (n <= 1 && (rt(e, s.done(t(r)).resolve, s.reject, !n),
    ...
    C.fn.ready = function(e) {
        ...
        "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? w.setTimeout(C.ready) : (T.addEventListener("DOMContentLoaded", st),
    ...
    function ht(e, t, n) {
        ...
        if (void 0 === n && 1 === e.nodeType)
            if (r = "data-" + t.replace(dt, "-$&").toLowerCase(),
        ...
        C.fn.extend({
            data: function(n, e) {
                ...
                1 === o.nodeType) && !m.get(o, "hasDataAttrs")) {
                    for (t = s.length; t--; )
                        s[t] && 0 === (r = s[t].name).indexOf("data-") && (r = L(r.slice(5)),
                            ht(o, r, i[r]));
    ...
    function Ct(e, t) {
        for (var n, r, i, o, s, a = [], u = 0, l = e.length; u < l; u++)
            (r = e[u]).style && (n = r.style.display,
                t ? ("none" === n && (a[u] = m.get(r, "display") || null,
                a[u] || (r.style.display = "")),
                "" === r.style.display && gt(r) && (a[u] = (s = o = void 0,
                    o = (i = r).ownerDocument,
    ...
    var St = /^(?:checkbox|radio)$/i
        ...
        , h = (o = T.createDocumentFragment().appendChild(T.createElement("div")),
            ...
            C.event.add(e, r, {
                ...
                handler: function(e) {
                    ...
                    if (1 & e.isTrigger && this[r]) {
                        ...
                        n && (m.set(this, r, C.event.trigger(n[0], n.slice(1), this)),
                            e.stopPropagation(),
    ...
    C.event = {
                ...
                for (o = C.event.handlers.call(this, a, e),
                    ...
                    for (a.currentTarget = r.elem,
                        ...
                        a.rnamespace && !1 !== i.namespace && !a.rnamespace.test(i.namespace) || (a.handleObj = i,
                            a.data = i.data,
                        void 0 !== (i = ((C.event.special[i.origType] || {}).handle || i.handler).apply(r.elem, s)) && !1 === (a.result = i) && (a.preventDefault(),
                            a.stopPropagation()));
                ...
                for (; l !== this; l = l.parentNode || this)
                    if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
                        for (o = [],
                                 s = {},
                                 n = 0; n < u; n++)
                            void 0 === s[i = (r = t[n]).selector + " "] && (s[i] = r.needsContext ? -1 < C(i, this).index(l) : C.find(i, this, null, [l]).length),
                            s[i] && o.push(r);
                        o.length && a.push({
                            elem: l,
                            handlers: o
        ...
        C.Event = function(e, t) {
            ...
            e && e.type ? (this.originalEvent = e,
                this.type = e.type,
                this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? qt : Lt,
        ...
        C.each({
            ...
            function o(e) {
                var t, n;
                T.documentMode ? (t = m.get(this, "handle"),
                    (n = C.event.fix(e)).type = "focusin" === e.type ? "focus" : "blur",
                    n.isSimulated = !0,
                    t(e),
                n.target === n.currentTarget && t(n)) : C.event.simulate(i, e.target, C.event.fix(e))
            }
            C.event.special[r] = {
                setup: function() {
                    var e;
    ...
    function Bt(n, r, i, o) {
        ...
        if (f && (t = (e = Dt(r, n[0].ownerDocument, !1, n, o)).firstChild,
        1 === e.childNodes.length && (e = t),
        t || o)) {
            for (a = (s = C.map(y(e, "script"), Wt)).length; c < f; c++)
                u = e,
                c !== p && (u = C.clone(u, !0, !0),
                    a) && C.merge(s, y(u, "script")),
                    i.call(n[c], u, c);
            if (a)
    ...
    function _t(e, t, n) {
        for (var r, i = t ? C.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            ...
            r.parentNode && (n && xt(r) && jt(y(r, "script")),
    ...
    function on(e, t, n) {
        ...
        return (n = n || zt(e)) && (r = n.getPropertyValue(t) || n[t],
        "" !== (r = i ? r && (r.replace(ee, "$1") || void 0) : r) || xt(e) || (r = C.style(e, t)),
            !g.pixelBoxStyles()) && Zt.test(r) && tn.test(t) && (i = o.width,
            e = o.minWidth,
            t = o.maxWidth,
    ...
    (H = T.createElement("div")).style && (H.style.backgroundClip = "content-box",
        ...
        C.extend(g, {
            ...
            reliableTrDimensions: function() {
                ...
                return null == Qt && (e = T.createElement("table"),
                    ...
                    Qt = parseInt(n.height, 10) + parseInt(n.borderTopWidth, 10) + parseInt(n.borderBottomWidth, 10) === t.offsetHeight,
                    vt.removeChild(e)),
                    Qt
            }
        }));
    ...
    function gn(e, t, n, r, i, o) {
        ...
        for (; s < 4; s += 2)
            "margin" === n && (l += C.css(e, n + mt[s], !0, i)),
                r ? ("content" === n && (u -= C.css(e, "padding" + mt[s], !0, i)),
                "margin" !== n && (u -= C.css(e, "border" + mt[s] + "Width", !0, i))) : (u += C.css(e, "padding" + mt[s], !0, i),
    ...
    function yn(e, t, n) {
        ...
        return (!g.boxSizingReliable() && i || !g.reliableTrDimensions() && b(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === C.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === C.css(e, "boxSizing", !1, r),
            o = a in e) && (s = e[a]),
        (s = parseFloat(s) || 0) + gn(e, t, n || (i ? "border" : "content"), o, r, s) + "px"
    }
    ...
    C.extend({
        ...
        css: function(e, t, n, r) {
            var i, o = L(t);
            return en.test(t) || (t = cn(o)),
            "normal" === (i = void 0 === (i = (o = C.cssHooks[t] || C.cssHooks[o]) && "get"in o ? o.get(e, !0, n) : i) ? on(e, t, r) : i) && t in dn && (i = dn[t]),
                ("" === n || n) && (o = parseFloat(i),
        ...
        C.each(["height", "width"], function(e, s) {
            C.cssHooks[s] = {
                get: function(e, t, n) {
                    if (t)
                        return !fn.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? yn(e, s, n) : Xt(e, pn, function() {
                            return yn(e, s, n)
                        })
                },
                set: function(e, t, n) {
        ...
        C.cssHooks.marginLeft = sn(g.reliableMarginLeft, function(e, t) {
            if (t)
                return (parseFloat(on(e, "marginLeft")) || e.getBoundingClientRect().left - Xt(e, {
                    marginLeft: 0
                }, function() {
    ...
    function P(i, e, t) {
        var n, o, r, s, a, u, l, c = 0, f = P.prefilters.length, p = C.Deferred().always(function() {
            ...
            if (!o) {
                for (var e = mn || Tn(), e = Math.max(0, h.startTime + h.duration - e), t = 1 - (e / h.duration || 0), n = 0, r = h.tweens.length; n < r; n++)
                    h.tweens[n].run(t);
    ...
    C.Animation = C.extend(P, {
        tweeners: {
            "*": [function(e, t) {
                ...
                return wt(n.elem, e, yt.exec(t), n),
                    n
            }
            ]
        },
        ...
        prefilters: [function(e, t, n) {
            ...
            if ((u = !C.isEmptyObject(t)) || !C.isEmptyObject(p))
                ...
                "none" === (c = C.css(e, "display")) && (l ? c = l : (Ct([e], !0),
                    l = e.style.display || l,
                    c = C.css(e, "display"),
                    Ct([e]))),
    ...
    var En, kn = C.expr.attrHandle, jn = (C.fn.extend({
        ...
        C.extend({
            attr: function(e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return void 0 === e.getAttribute ? C.prop(e, t, n) : (1 === o && C.isXMLDoc(e) || (i = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? En : void 0)),
                ...
                return v(t) ? this.each(function(e) {
                    ...
                    this.each(function() {
                        if (a)
                            ...
                            void 0 !== t && "boolean" != s || ((r = Nn(this)) && m.set(this, "__className__", r),
            ...
            r || !l.trigger || !1 !== l.trigger.apply(n, t))) {
                if (!r && !l.noBubble && !R(n)) {
                    for (s = l.delegateType || p,
                         Rn.test(s + p) || (h = h.parentNode); h; h = h.parentNode)
                        f.push(h),
                            o = h;
                ...
                return e.type = p,
                r || e.isDefaultPrevented() || l._default && !1 !== l._default.apply(f.pop(), t) || !ct(n) || a && v(n[p]) && !R(n) && ((o = n[a]) && (n[a] = null),
                    C.event.triggered = p,
    ...
    Jn.href = On.href,
        C.extend({
            ...
            ajax: function(e, t) {
                ...
                if (m.promise(b),
                    h.url = ((e || h.url || On.href) + "").replace(Vn, On.protocol + "//"),
                ...
                null == h.crossDomain) {
                    ...
                    try {
                        e.href = h.url,
                            e.href = e.href,
                            h.crossDomain = Jn.protocol + "//" + Jn.host != e.protocol + "//" + e.host
                    } catch (e) {
                        h.crossDomain = !0
                    }
                }
                ...
                function a(e, t, n, r) {
                    ...
                    !r && -1 < C.inArray("script", h.dataTypes) && C.inArray("json", h.dataTypes) < 0 && (h.converters["text script"] = function() {}
                    ),
                        s = ( (e, t, n, r) => {
    ...
    var tr = {
        ...
        , rr = (g.cors = !!nr && "withCredentials"in nr,
        g.ajax = nr = !!nr,
        ...
        C.parseHTML = function(e, t, n) {
            ...
            t || (g.createHTMLDocument ? ((r = (t = T.implementation.createHTMLDocument("")).createElement("base")).href = T.location.href,
                ...
                r = !n && [],
                (n = Ge.exec(e)) ? [t.createElement(n[1])] : (n = Dt([e], t, r),
