...
<div>
    <div class="col-lg-8">
        ...
        <div>
            ...
            <g:if test="${layer_creation != null && !has_layer}"><h2
                    style="color:red">Layer created: <b>${has_layer}</b></h2><br/>
            ...
            <div class="tab-content">
                ...
                <div ole="tabpanel" class="tab-pane" id="geoserverPreview">
                    ...
                    <script>
                        ...
                        var wmsLayer2 = L.tileLayer.betterWms("${spatialConfig.geoserver.url}/wms", {
                ...
                <div cole="tabpanel" class="tab-pane active" id="settings">
                    ...
                    <form method="POST">
                        ...
                        <table class="table table-condensed">
                            ...
                            <tr>
                                <td>
                                    <label for="description">Description (A short description of this layer):</label>
                                </td><td>
                            ...
                            <tr>
                                ...
                                <g:if test="${layer_creation != null || has_layer}">
                                    <input class="form-control" readonly type="text" id="type" name="type"
                                           value="${type}"
                                           maxlength="150"/>
                                </g:if>
                            </td></tr><tr><td>
                            ...
                            <g:if test="${layer_creation != null || has_layer}">
                                <input class="form-control" readonly type="text" id="domain" name="domain"
                                       value="${domain}"
                                       maxlength="150"/>
                            </g:if>
                        </td></tr><tr><td>
                        ...
                        <input class="form-control"
                                ...
                                maxlength="150" <g:if
                                    test="${layer_creation != null || has_layer}">readonly="true"</g:if>
                        </input>
                        </td></tr><tr><td>
                            ...
                            <label for="licence_notes">Licence notes (details of the licence, e.g. "CC BY")</label>
                        </td><td>
                            ...
                            <textarea class="form-control" id="notes" name="notes" cols="150"
