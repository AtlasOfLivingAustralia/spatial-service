    ...
    <div>
        <g:if test="${status == 401}">
            ...
            <div>
                ...
                <div>
                    If automatic redirection is not occurring in few seconds, <a href="${url}" class="btn btn-info"
        ...
        <g:elseif test="${status == 403}">
            <div class="alert alert-warning"
                 role="alert">You do not have permission to access this link. Please sign in with another account.</div>
        </g:elseif>
    </div>
</div>
</body>
